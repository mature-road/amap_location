...
class com_amap_api_location_AMapLocation extends android_location_Location with android_os_Parcelable {
  ...
  //region creators
  static Future<Future> create__String(String var1) async {
  ...
  static Future<Future> create__android_location_Location(android_location_Location var1) async {
  ...
  static Future<Future<List<com_amap_api_location_AMapLocation>?>> create_batch__String(List<String> var1) async {
    if (false) {
  ...
  static Future<Future<List<com_amap_api_location_AMapLocation>?>> create_batch__android_location_Location(List<android_location_Location> var1) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
